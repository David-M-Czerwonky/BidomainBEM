...
subplot(3,3,9)
semilogx(distance,error1_thick,'LineStyle','-','Color',"#FF7518",'LineWidth', 3)% dark orange
hold on
semilogx(distance,error2_thick,'LineStyle','-.','Color',"#FA8072",'LineWidth', 3) %light orange
ylim([0,100])
xlabel("d (m)", 'FontSize', 12);
% ylabel("Percentatge (%)", 'FontSize', 10);
