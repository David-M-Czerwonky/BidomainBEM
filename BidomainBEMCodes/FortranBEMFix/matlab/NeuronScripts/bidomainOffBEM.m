function [ Vmem Imstore rhostore t_mem p_mem tri p BEM2 rhoRHSeul rhoRHSAmat]=bidomainOffBEM(RHS,wave,amp,tarr,type,p,tri,sigav,sigdiff,rhotoIm,p_mem,sig,BEM2)
