...
%
% Description: This script produces the bidomain data shown in the TES plot
% of figure 4 (C). 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%solve the bidomain BEM equations at every time step
[ Vm Im rho t_mem p_mem tria pa BEM]=bidomainBEM(RHS,wave,-amp,tarr,'CN2',p',tri',sigav,sigdiff,rhotoIm,1:(numel(V)/3),sig);
